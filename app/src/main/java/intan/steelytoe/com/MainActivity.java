...
import intan.steelytoe.com.ui.activity.FileGpxActivity;
import intan.steelytoe.com.ui.activity.SettingActivity;
import intan.steelytoe.com.ui.activity.list.ListViewLoc;
import intan.steelytoe.com.ui.activity.list.ListViewSmsFailed;
import intan.steelytoe.com.ui.activity.list.ListViewSmsSent;
import intan.steelytoe.com.ui.fragments.display.GpsDetailViewFragment;
import intan.steelytoe.com.ui.fragments.display.RunningHistoryFragmet;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.nav_manage:
                intent = new Intent(this, FileGpxActivity.class);
                break;
            case R.id.setting:
                intent = new Intent(this, SettingActivity.class);
                break;
            case R.id.history:
                loadRunningHistoryFragment();
                break;
            default:
                loadFragmentView(0);
    ...
    private void loadRunningHistoryFragment() {
        getSupportFragmentManager().beginTransaction()
                .replace(R.id.container_2, RunningHistoryFragmet.newInstance(null, null))
                .addToBackStack(RunningHistoryFragmet.class.getSimpleName())
                .commit();
    }
