...
import static intan.steelytoe.com.model.TempLoaction.KEY_lat;
import static intan.steelytoe.com.model.TempLoaction.KEY_lng;
...
//                getActivity().stopService(serviceSmsFailed);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng startPointSosmap = new LatLng(-6.367026,106.890362);
        CameraPosition cameraPosition = new CameraPosition.Builder()
                .target(startPointSosmap)    // Sets the center of the map to location user
                .zoom(10)                   // Sets the zoom
                .bearing(90)                // Sets the orientation of the camera to east
                .tilt(40)                   // Sets the tilt of the camera to 30 degrees
                .build();

        mMap.addMarker(new MarkerOptions().position(startPointSosmap).title("Start Point"));
        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(startPointSosmap,13));
    ...
    class loadJSONFromAsset extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... urls) {
            String json = null;
            try {
                InputStream is = getActivity().getAssets().open("sosmap_bak.json");
