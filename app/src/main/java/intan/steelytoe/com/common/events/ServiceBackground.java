...
import intan.steelytoe.com.MainActivity;
...
import intan.steelytoe.com.common.Strings;
import intan.steelytoe.com.loggers.FileLoggerFactory;
...
public class ServiceBackground extends Service implements GoogleApiClient.OnConnectionFailedListener,
    ...
    */
    ...
    private void createLocationRequest() {
        ...
        mLocationRequest.setPriority(PrefManager.getInstance(this).getLocationAccuracyPriority());
    }
        ...
        if (notifBuilder == null){
           notifBuilder = new NotificationCompat.Builder(this);
            notifBuilder
                    ...
                    .setSmallIcon(R.mipmap.ic_notificon_steelytoe)
                    .setAutoCancel(true)
                    .addAction(0, "OPEN", pendingIntent);

        }

        notifBuilder.setContentText(timerString);
    ...
    private void setBestLocation(Location loc){
        ...
        if (previousBestLocation == null) {
            ...
            if(true) {  //if(isLocationOke(previousBestLocation, loc))
...
//        cancelAlarm();
    ...
    private final void insertToSQLiteDatabase(Location loc, String timer){
        ...
        tempLoaction.setLat(String.valueOf(loc.getLatitude()));
        tempLoaction.setLng(String.valueOf(loc.getLongitude()));
        tempLoaction.setTimer(timer);
        tempLoaction.setId(_Id);
        tempLoaction.setRunningId(PrefManager.getInstance(this).getRunningId());
        tempLoaction.setDate(PrefManager.getInstance(this).getDateHeader());
